...
OhdsiRTools::checkUsagePackage("ppi0623")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ppi0623.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ppi0623.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ppi0623")
